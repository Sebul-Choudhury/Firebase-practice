...
const [user, setUser] = useState({
  ...
  const handleSignIn = () =>{firebase.auth().signInWithPopup(provider)
.then (res =>{
...

{
  ...
  <button onClick={handleSignIn}>Signin With Gmail</button>
  }
  <br/>
  <button onClick={handleFbLogIn}>Signin With Facebook</button>
{
  user.isSignedIn && <div>
